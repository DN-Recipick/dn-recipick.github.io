...
import { useModalEffect } from '@/components/hooks/useModalEffect';
import IngredientDetail from '@/features/recipeDetail/components/IngredientDetail';
import RecommendedRecipes from '@/features/recipeDetail/components/RecommendedRecipes';
